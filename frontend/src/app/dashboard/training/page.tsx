  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-semibold text-foreground">Обучающие материалы</h2>
        {canEdit && (
          <button 
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-card rounded-xl shadow-xl w-full max-w-2xl p-6">
            <h3 className="text-lg font-medium text-foreground mb-4">Новый обучающий материал</h3>

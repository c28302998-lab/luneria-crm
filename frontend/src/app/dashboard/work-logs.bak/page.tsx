    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center text-muted-foreground">Нет записей о сменах на эту дату</div>
        ) : (
          <table className="min-w-full divide-y divide-border">
            <thead className="bg-background">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Начало</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Конец</th>
              ...
              {shifts.map((shift) => (
                <tr key={shift.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="font-medium text-foreground">{shift.user?.name}</div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {shift.end_time ? (
                      <span className="px-2 py-1 bg-muted text-muted-foreground rounded-md text-xs font-medium">Завершена</span>
                    ) : (
